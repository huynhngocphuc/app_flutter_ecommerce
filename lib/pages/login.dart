...
class _LoginState extends State<Login> {
  ...
  InputDecoration customFormField(String text){
    return InputDecoration(
        hintText: text,
        labelText: text,
        prefixIcon: Icon(text == TLG_PASS_TEXT ? Icons.lock : Icons.email),
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      TextFormField(
                        decoration: customFormField(TLG_EMAIL_TEXT),
                      ...
                      TextFormField(
                        obscureText: true,
                        decoration: customFormField(TLG_PASS_TEXT),
                        validator: (value) => _validateService.isEmptyField(value),
                        onSaved: (String val){
