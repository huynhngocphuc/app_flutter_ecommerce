...
class _EditProfileState extends State<EditProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      key: _scaffoldKey,
      appBar: header('Sửa thông tin', _scaffoldKey, showCartIcon, context),
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    TextFormField(
                      decoration: customFormField('Tên'),
              ...
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      decoration: customFormField('SĐT'),
