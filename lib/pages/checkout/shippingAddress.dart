...
class _ShippingAddressState extends State<ShippingAddress> {
  ...
  checkoutAddress(){
    ...
    if(selectedAddress == null){
      String msg = 'Vui lòng chọn địa chi';
  ...
  validateInput() async{
    ...
    if(connectionStatus){
      if(_formKey.currentState.validate()){
        ...
        print("địa chỉ mới lưu $shippingAddress");
      }
      else{
        setState(() {
          autoValidate = true;
  ...
  listShippingAddress() async{
    ...
    if(connectionStatus){
      ...
      print("da lay duoc dia chi ${shippingAddress.length}");
    }
    else{
      internetConnectionDialog(context);
    }
  ...
  showSavedAddress(){
    print("dia chi da nhan0  ${shippingAddress} --- ${addressValues}");
    return Container(
      child: Column(
        children: <Widget>[
          ListView.builder(
                    ...
                    children: <Widget>[
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                              "Số điện thoại: ${item['mobileNumber']}"
                          )
                        ],
                      ),
                      Radio(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: CheckoutAppBar('Trở lại','Tiếp',this.checkoutAddress),
      body: Container(
        child: Padding(
